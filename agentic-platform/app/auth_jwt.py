...
class Settings:
    ...
    ENABLE_SQL_TOOL: bool = os.getenv(
        "ENABLE_SQL_TOOL", "true").lower() == "true"
    ENABLE_MEMORY: bool = os.getenv("ENABLE_MEMORY", "true").lower() == "true"

    # =============================
    # GOVERNANCE
    # =============================
    ENABLE_CONTENT_FILTER: bool = os.getenv(
        "ENABLE_CONTENT_FILTER", "true").lower() == "true"
    ENABLE_AUDIT_LOGS: bool = os.getenv(
        "ENABLE_AUDIT_LOGS", "true").lower() == "true"
